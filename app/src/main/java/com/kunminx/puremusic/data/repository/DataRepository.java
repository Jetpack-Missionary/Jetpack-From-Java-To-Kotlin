...
public class DataRepository implements ILocalRequest, IRemoteRequest {
    ...
    public void getKotlinItems(MutableLiveData<List<GridItem>> liveData) {
        ...
        list.add(new GridItem(getUUID(), "XX", R.drawable.bg_album_default, "com.kunminx.jetpack_j2k", "com.flywith24.jetpack_kotlin.sample_01_lifecycles.ui.LifecycleDetailActivity"));
