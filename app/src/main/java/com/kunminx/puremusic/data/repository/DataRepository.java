...
public class DataRepository implements ILocalRequest, IRemoteRequest {
    ...
    public void getJavaItems(MutableLiveData<List<GridItem>> liveData) {
        ...
        list.add(new GridItem("Lifecycles", R.drawable.bg_album_default, "com.kunminx.jetpack_j2k", "com.example.jetpack_java.lifecycles.ui.LifecycleDetailActivity"));
        list.add(new GridItem("Lifecycles", R.drawable.bg_album_default, "com.kunminx.jetpack_j2k", "com.example.jetpack_java.lifecycles.ui.LifecycleDetailActivity"));
        list.add(new GridItem("Lifecycles", R.drawable.bg_album_default, "com.kunminx.jetpack_j2k", "com.example.jetpack_java.lifecycles.ui.LifecycleDetailActivity"));
        list.add(new GridItem("Lifecycles", R.drawable.bg_album_default, "com.kunminx.jetpack_j2k", "com.example.jetpack_java.lifecycles.ui.LifecycleDetailActivity"));
        list.add(new GridItem("Lifecycles", R.drawable.bg_album_default, "com.kunminx.jetpack_j2k", "com.example.jetpack_java.lifecycles.ui.LifecycleDetailActivity"));
    ...
    public void getKotlinItems(MutableLiveData<List<GridItem>> liveData) {
        ...
        List<GridItem> list = new ArrayList<>();
        list.add(new GridItem("Lifecycles", R.drawable.bg_album_default, "com.kunminx.jetpack_j2k", "com.example.jetpack_kotlin.lifecycles.ui.LifecycleDetailActivity"));
        list.add(new GridItem("Lifecycles", R.drawable.bg_album_default, "com.kunminx.jetpack_j2k", "com.example.jetpack_kotlin.lifecycles.ui.LifecycleDetailActivity"));
        list.add(new GridItem("Lifecycles", R.drawable.bg_album_default, "com.kunminx.jetpack_j2k", "com.example.jetpack_kotlin.lifecycles.ui.LifecycleDetailActivity"));
        list.add(new GridItem("Lifecycles", R.drawable.bg_album_default, "com.kunminx.jetpack_j2k", "com.example.jetpack_kotlin.lifecycles.ui.LifecycleDetailActivity"));
        list.add(new GridItem("Lifecycles", R.drawable.bg_album_default, "com.kunminx.jetpack_j2k", "com.example.jetpack_kotlin.lifecycles.ui.LifecycleDetailActivity"));
