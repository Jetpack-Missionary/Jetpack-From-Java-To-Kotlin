...
import com.kunminx.jetpack_java.databinding.FragmentEditorRoomBinding;
 ...
 */
public class RoomEditorFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_editor_room, container, false);
        FragmentEditorRoomBinding binding = FragmentEditorRoomBinding.bind(view);
